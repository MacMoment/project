...
export default function HomePage() {
  return (
    <>
      ...
      {/* CTA Section */}
      <section className="relative py-20 bg-gradient-to-br from-[#0b0a16] via-[#1b1333] to-[#24104d] overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          <div className="rounded-3xl border border-white/15 bg-white/5 backdrop-blur-2xl px-8 py-12 shadow-[0_30px_80px_-50px_rgba(255,255,255,0.45)] ring-1 ring-white/10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link 
                to="/store" 
                className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-white to-purple-100 text-gray-900 font-semibold rounded-xl hover:opacity-90 transition-all shadow-lg shadow-white/20"
              >
                Browse Store
